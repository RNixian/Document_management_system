                ...
                <div class="btn-group" role="group">
                    <?php if ($user['id'] !== $_SESSION['user_id']): ?>
                        ...
                        <button type="button" class="btn btn-danger ms-2"
                                onclick="if(confirm('Are you sure you want to delete this user? This will also delete all their documents. This action cannot be undone.')) { 
                                    const form = document.createElement('form');
                                    form.method = 'POST';
                                    form.action = 'users.php';
                                    form.innerHTML = '<input type=\'hidden\' name=\'action\' value=\'delete_user\'><input type=\'hidden\' name=\'user_id\' value=\'<?php echo $user['id']; ?>\'>';
