...
// Filter
$division_filter = isset($_GET['division']) ? (int)$_GET['division'] : 0; // 0 means all
...
.border-left-primary { border-left: 0.25rem solid #000207ff !important; }
.border-left-success { border-left: 0.25rem solid #000207ff !important; }
.border-left-info { border-left: 0.25rem solid #000207ff !important; }
.border-left-warning { border-left: 0.25rem solid #000207ff !important; }
...
.card { position: relative; display: flex; flex-direction: column; min-width: 0; word-wrap: break-word; background-color: #050455ff; background-clip: border-box; border: 1px solid #e3e6f0; border-radius: 0.35rem; }
.shadow { box-shadow: 0 0.15rem 1.75rem 0 rgba(58, 59, 69, 0.15) !important; }
.py-2 { padding-top: 0.5rem !important; padding-bottom: 0.5rem !important; }
.py-3 { padding-top: 1rem !important; padding-bottom: 1rem !important; }
.h-100 { height: 100% !important; }
.card-header {    background: linear-gradient(90deg, #0b257cff 0%, #010b33ff 100%);color: white; border-bottom: 1px solid #e3e6f0; }
.dashboard-header { background: #010931ff; color: white; border-radius: 0.75rem; margin-bottom: 2rem; border: none; box-shadow: 0 0.5rem 2rem rgba(102, 126, 234, 0.3); }
...
.dashboard-header .welcome-text { background: rgba(8, 17, 100, 0.15); border-radius: 0.5rem; padding: 1rem 1.5rem; backdrop-filter: blur(10px); border: 1px solid rgba(255, 255, 255, 0.2); }
...
.bg-light { background-color: #f8f9fc !important; border: 1px solid #e3e6f0; transition: all 0.3s ease; }
    ...
    <?php foreach ($divisions as $division): ?>
        <a href="?division=<?= $division['id'] ?>" 
           ...
           style="cursor: pointer; display: flex; flex-direction: column; 
            ...
            <span style="color: #111010ff; font-weight: 600;">
...
<div id="documents-container" class="card shadow bg-dark text-white">
    ...
    <div class="card-body">
        <?php if (empty($documents)): ?>
            <div class="text-center text-white py-4">No files found for this department.</div>
        <?php else: ?>
            <div class="row">
