...
<div class="container-fluid px-4">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card border-0" style="background: linear-gradient(90deg, #0b257cff 0%, #010b33ff 100%); color: white;">
...
.upload-area.dragover {
    border-color: #010b33ff !important;
    ...
    function handleFileSelection(files) {
        ...
        files.forEach(file => {
            ...
            if (file.size > maxFileSize) {
                showAlert(`File "${file.name}" is too large. Maximum size is 500MB.`, 'warning');
                return;
            }
